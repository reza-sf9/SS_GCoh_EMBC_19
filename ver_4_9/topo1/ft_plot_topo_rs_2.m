function [Zi, h] = ft_plot_topo_rs_2(chanX, chanY, dat , win_num , colorbar_limit , str_colormap , str_description)
...
load('D:\Ali new work\code\Global Coherence\topo_plot\intial_ft_plot_topo.mat');
...
%%%%%% REZA CODE
c = colorbar('FontSize',25);
set(c,'XTick',[.2:.2:.6])
set(c,'Position',[0.44 0.10 0.45 0.8])% To change size
